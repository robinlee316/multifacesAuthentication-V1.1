...
namespace faceDetection
{
	...
	public partial class MainWindow : Window
	{
		...
		//    static FaceServiceClient faceServiceClient = new FaceServiceClient("XXXXXXXXXXXXXXXXXXXXX");
		// New Subscription Key April 19,2017
		static FaceServiceClient faceServiceClient = new FaceServiceClient("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX");
